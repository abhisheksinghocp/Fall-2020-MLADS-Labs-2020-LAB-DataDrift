...
---
title: "Data_drift_parquet_Scoring"
output:
  html_document:
    toc: true
---
...
date <- Sys.Date()
dir <- paste('Data_Drift','/',model_name,'/Scoring','/',date,sep="")  # changes will apply once location is final
...
dir <- paste('/Data_Drift','/',model_name,'/Scoring','/',date,sep="")
print(dir)
